...
func TestIsErrorType(t *testing.T) {
	...
	assert.That(t, util.IsErrorType(nil)).False()
	assert.That(t, util.IsErrorType(reflect.TypeFor[int]())).False()
	assert.That(t, util.IsErrorType(reflect.TypeOf((*error)(nil)).Elem())).True()
}
...
func TestReturnNothing(t *testing.T) {
	...
	assert.That(t, util.ReturnNothing(reflect.TypeOf(func(key string, value int) {}))).True()
	assert.That(t, util.ReturnNothing(reflect.TypeOf(func() (int, error) { return 0, nil }))).False()
}
...
func TestReturnOnlyError(t *testing.T) {
	...
	assert.That(t, util.ReturnOnlyError(reflect.TypeOf(func() {}))).False()
	//nolint:staticcheck // reason: testing ReturnOnlyError with an invalid signature
	assert.That(t, util.ReturnOnlyError(reflect.TypeOf(func() (error, string) { return nil, "" }))).False()
	assert.That(t, util.ReturnOnlyError(reflect.TypeOf(func(int, string) error { return nil }))).True()
}
...
func TestIsConstructor(t *testing.T) {
	...
	assert.That(t, util.IsConstructor(reflect.TypeOf(func() (int, error) { return 0, nil }))).True()
	assert.That(t, util.IsConstructor(reflect.TypeOf(func(string) *receiver { return nil }))).True()
	assert.That(t, util.IsConstructor(reflect.TypeOf(func() (*receiver, *receiver) { return nil, nil }))).False()
}
...
func TestIsBeanInjectionTarget(t *testing.T) {
	...
	assert.That(t, util.IsBeanInjectionTarget(reflect.TypeOf((*fmt.Stringer)(nil)).Elem())).True()
	assert.That(t, util.IsBeanInjectionTarget(reflect.TypeOf([]error{}))).True()
	assert.That(t, util.IsBeanInjectionTarget(reflect.TypeOf(map[string]error{}))).True()
	assert.That(t, util.IsBeanInjectionTarget(nil)).False()
}
