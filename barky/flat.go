...
// Nil values are skipped, and empty maps/slices are represented as empty strings.
...
// FlattenValue is a recursive helper function that processes a value
// (map, slice, array, or primitive) and stores its flattened representation
// into the result map under the given key. Nested structures are expanded
// using dot/index notation.
